# Generated by Django 2.2.3 on 2020-07-27 19:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arbitrary_characteristics', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=None)),
                ...
                ('geophysical_concepts', models.ManyToManyField(related_name='instruments', to='data_models.GeophysicalConcept')),
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='data_models.Image')),
