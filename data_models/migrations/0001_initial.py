...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, null=True, upload_to=data_models.models.get_file_path
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, default=None, related_name="platforms", to="data_models.DOI"
                    ),
                ),
                (
                    "gcmd_platforms",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dois",
                    models.ManyToManyField(
                        blank=True, default=None, related_name="instruments", to="data_models.DOI"
                    ),
                ),
                (
                    "gcmd_instruments",
                ...
                (
                    "gcmd_phenomenas",
                    models.ManyToManyField(
                        related_name="instruments", to="data_models.GcmdPhenomena"
                    ),
                ),
                (
                    "image",
                ...
                (
                    "instrument_types",
                    models.ManyToManyField(
                        related_name="instruments", to="data_models.InstrumentType"
                    ),
                ),
                (
                    "measurement_regions",
                    models.ManyToManyField(
                        related_name="instruments", to="data_models.MeasurementRegion"
                    ),
                ),
                (
                    "repositories",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "instruments",
                    models.ManyToManyField(
                        related_name="collection_periods", to="data_models.Instrument"
                    ),
                ),
                (
                    "platform",
        ...
        migrations.AddField(
            ...
            name="gcmd_projects",
            field=models.ManyToManyField(
                blank=True, default="", related_name="campaigns", to="data_models.GcmdProject"
            ),
        ),
        migrations.AddField(
            model_name="campaign",
            ...
            field=models.ManyToManyField(
                related_name="campaigns", to="data_models.GeophysicalConcept"
            ),
        ),
        migrations.AddField(
            model_name="campaign",
        ...
        migrations.AddField(
            ...
            name="nasa_missions",
            field=models.ManyToManyField(
                blank=True, default="", related_name="campaigns", to="data_models.NasaMission"
            ),
        ),
        migrations.AddField(
            model_name="campaign",
            name="partner_orgs",
            field=models.ManyToManyField(
                blank=True, default="", related_name="campaigns", to="data_models.PartnerOrg"
            ),
        ),
        migrations.AddField(
            model_name="campaign",
