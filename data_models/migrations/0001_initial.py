# Generated by Django 2.2.3 on 2020-05-20 18:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_short', models.CharField(blank=True, default='', max_length=16384)),
                ('description_long', models.CharField(blank=True, default='', max_length=16384)),
                ...
                ('funding_agency', models.CharField(blank=True, default='', max_length=256)),
                ...
                ('lead_investigator', models.CharField(blank=True, default='', max_length=65535)),
                ...
                ('nasa_led', models.BooleanField(blank=True, default=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('long_name', models.CharField(blank=True, default='', max_length=512)),
                ('notes_public', models.CharField(blank=True, default='', max_length=16384)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('short_name', models.CharField(blank=True, default='', max_length=256)),
                ('long_name', models.CharField(blank=True, default='', max_length=512)),
                ...
                ('gcmd_uuid', models.TextField(blank=True, max_length=2048, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_name', models.CharField(max_length=256, unique=True)),
                ('long_name', models.CharField(blank=True, default='', max_length=512)),
                ('bucket', models.CharField(blank=True, default='', max_length=256)),
                ('gcmd_uuid', models.TextField(blank=True, max_length=2048, null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_resources', models.TextField(blank=True, max_length=2048, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spatial_resolution', models.CharField(blank=True, default='', max_length=256)),
                ('temporal_resolution', models.CharField(blank=True, default='', max_length=256)),
                ('radiometric_frequency', models.CharField(blank=True, default='', max_length=256)),
                ...
                ('gcmd_phenomenas', models.ManyToManyField(blank=True, default='', related_name='instruments', to='data_models.GcmdPhenomena')),
                ('geophysical_concepts', models.ManyToManyField(blank=True, default='', related_name='instruments', to='data_models.GeophysicalConcept')),
                ('instrument_types', models.ManyToManyField(blank=True, default='', related_name='instruments', to='data_models.InstrumentType')),
                ('measurement_regions', models.ManyToManyField(blank=True, default='', related_name='instruments', to='data_models.MeasurementRegion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes_internal', models.CharField(blank=True, default='', max_length=16384)),
                ('notes_public', models.CharField(blank=True, default='', max_length=16384)),
                ('num_ventures', models.PositiveIntegerField(blank=True, null=True)),
                ('auto_generated', models.BooleanField(blank=True, default=True)),
        ...
        migrations.AddField(
            model_name='campaign',
            name='focus_areas',
            field=models.ManyToManyField(blank=True, default='', related_name='campaigns', to='data_models.FocusArea'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='gcmd_phenomenas',
            field=models.ManyToManyField(blank=True, default='', related_name='campaigns', to='data_models.GcmdPhenomena'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='gcmd_projects',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, default='', related_name='campaigns', to='data_models.GeophysicalConcept'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='nasa_missions',
        ...
        migrations.AddField(
            model_name='campaign',
            name='platform_types',
            field=models.ManyToManyField(blank=True, default='', related_name='campaigns', to='data_models.PlatformType'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='repositories',
            field=models.ManyToManyField(blank=True, default='', related_name='campaigns', to='data_models.Repository'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='seasons',
            field=models.ManyToManyField(blank=True, default='', related_name='campaigns', to='data_models.Season'),
        ),
        migrations.CreateModel(
            name='Alias',
            fields=[
