...
class GcmdProjects(GCMD):
    pass


class GcmdPlatforms(GCMD):
    pass


class GcmdInstruments(GCMD):
    pass
...
class Platform(models.Model):
    ...
    gcmd_platform = models.ManyToManyField(GcmdProjects, related_name='platforms')  # TODO: double check
