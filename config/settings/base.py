...
ROOT_DIR = environ.Path(__file__) - 3  # (admg_webapp/config/settings/base.py - 3 = admg_webapp/)
APPS_DIR = ROOT_DIR.path("admg_webapp")
...
MIGRATION_MODULES = {"sites": "admg_webapp.contrib.sites.migrations"}
...
ADMINS = [("""Carson Davis""", "Carson.Davis@nasa.gov")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "admg_webapp.users.adapters.SocialAccountAdapter"
