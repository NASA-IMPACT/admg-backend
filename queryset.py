...
from data_models.models import Alias, Campaign, CollectionPeriod, DOI, Deployment, FocusArea, GcmdInstrument, GcmdPhenomenon, GcmdPlatform, GcmdProject, GeographicalRegion, GeophysicalConcept, HomeBase, IOP, Image, Instrument, MeasurementRegion, MeasurementStyle, MeasurementType, PartnerOrg, Platform, PlatformType, Repository, Season, SignificantEvent, Website, WebsiteType
